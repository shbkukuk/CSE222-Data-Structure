...
public class Account {
    ...
    public List<Post> postsArray; 
    /** Keep all actions of the user */
    protected List<String> historyActions;
    /** Keep all inbox message of the user */
    protected List<Message> inboxArray; 
    /** Keep all outbox message of the user */
    protected List<Message> outboxArray; 
    /** Keep all followers of the user */
    protected List <Account> followers; 
    /** Keep all following of the user */
    protected List <Account> following; 
    /**Keep all blocked account by the user */
    private List <Account> block;
    ...
    */
    ...
    public Account(int accID,String loginName, String dateOfBirth, String site){
        ...
        this.inboxArray = new ArrayList<>();
        this.outboxArray = new ArrayList<>();
